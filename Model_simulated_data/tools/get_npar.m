...
elseif   strcmp(modelID,'ms_RWPL_SO_LR'),                 npar = 3;
elseif   strcmp(modelID,'ms_RWPL_SO_LR_comb'),            npar = 3;
elseif   strcmp(modelID,'ms_RWPL_SON_LR_SON_beta'),       npar = 4;
elseif   strcmp(modelID,'ms_RWPL_SON_beta'),              npar = 4;
elseif   strcmp(modelID,'ms_RWPL_SO_LR_group'),           npar = 5;
elseif   strcmp(modelID,'ms_RWPL_temp'),                  npar = 6;
elseif   strcmp(modelID,'ms_RWPL_temp_bias'),             npar = 6;
