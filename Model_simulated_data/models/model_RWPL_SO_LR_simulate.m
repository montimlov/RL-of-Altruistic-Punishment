...
%    RL model with a self other & no one seperate learning rates and one beta parameter

function [f, allout] = model_RWPL_SO_LR_simulate(data,normalPE,block,agent,p,alphabounds,betabounds)
